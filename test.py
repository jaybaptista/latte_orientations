def axis_ratio_calculation(comp, tolerance, iters_max, r_max):
    ...
    if   (comp == 'star'): x = x_star; y = y_star; z = z_star; m = m_star; d_tot = d_tot_star
    elif (comp == 'gass'): x = x_gass; y = y_gass; z = z_gass; m = m_gass; d_tot = d_tot_gass
    elif (comp == 'dark'): x = x_dark; y = y_dark; z = z_dark; m = m_dark; d_tot = d_tot_dark
    elif (comp == 'totl'):
    ...
    axis_ratios_comp = np.array([s, p, q, a, b, c,
