...
radii_list = [
    "../scale_radii/scale_radii_z_fullres_m12f_res7100.asdf",
    "../scale_radii/scale_radii_z_fullres_m12i_res7100.asdf",
    "../scale_radii/scale_radii_z_fullres_m12m_res7100.asdf",
    "../scale_radii/scale_radii_z_fullres_m12w_res7100.asdf",
]
...
for k, sim in enumerate(simulation_list):
    ...
    ref_snap = pericenter_data[sim_name]["snapshot"]
    window = 20
    
    snapshot_range = np.arange(ref_snap-window, ref_snap+window+1, step=1)
    ...
    af.write_to(f"v_sigma_ratios_fullres_{sim_name}.asdf")